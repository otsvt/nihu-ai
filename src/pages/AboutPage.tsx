    ...
    <motion.div className="inner-page" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <section className="inner-hero about-hero">
        <div className="inner-hero-copy">
          ...
          <h1>Мы создаём будущее, которого <em>НИХУ-AI</em> не просил</h1>
          <p>НИХУ-AI появился после того, как наш основатель увидел очередной пост о SaaS, созданном за два дня и уже обслуживающем десятки тысяч пользователей.</p>
        </div>
        <div className="founding-card">
          ...
          <div><span /> Компания вероятно существует</div>
        </div>
      </section>
      ...
      <section className="section story-section">
        ...
        <div className="story-copy">
          <p>Компания была основана 14 минут назад после тщательного анализа рынка, состоявшего из трёх постов в Threads и одного видео на YouTube.</p>
          <p>Мы заметили, что современному продукту необязательно иметь пользователей, ценность или рабочий функционал. Достаточно красивого лендинга, уверенного тона и графика, который идёт вверх.</p>
      ...
      <section className="section mission">
        ...
        <p>Что отличает нас от конкурентов? <strong>НИХУ-AI</strong></p>
      </section>
      ...
      <section className="section about-final">
        ...
        <Link className="button" to="/donate">Присоединиться к НИХУ-AI</Link>
      </section>
    </motion.div>
  )
}
